...
from electrum_boli import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_boli.bitcoin import is_address, COIN
...
def receive_loop():
    ...
    while out is None:
        ...
        if not event:
            ...
            amount = modal_input('Amount', 'Amount you want to receive (in BOLI). ', format_satoshis(receive_amount) if receive_amount else None, "numberDecimal")
