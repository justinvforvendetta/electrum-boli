...
from electrum_boli.util import print_error, InvalidPassword
from electrum_boli.bitcoin import is_valid, COIN
from electrum_boli.wallet import NotEnoughFunds
from electrum_boli import WalletStorage, Wallet
...
from electrum_boli.util import format_satoshis, parse_URI
from electrum_boli.bitcoin import MIN_RELAY_TX_FEE
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        from electrum_boli.util import StoreDict
