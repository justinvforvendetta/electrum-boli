...
from electrum_boli.plugins import run_hook, always_hook
...
class ElectrumGui:
    ...
    def init_lite(self):
        ...
        if not self.check_qt_version():
            if self.config.get('lite_mode') is True:
                msg = "Electrum-BOLI was unable to load the 'Lite GUI' because it needs Qt version >= 4.7.\nChanging your config to use the 'Classic' GUI"
    ...
    def main(self, url):
        ...
        self.tray.setToolTip('Electrum-BOLI')
