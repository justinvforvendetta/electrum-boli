...
REQUEST_HEADERS = {'Accept': 'application/boli-paymentrequest', 'User-Agent': 'Electrum'}
ACK_HEADERS = {'Content-Type':'application/boli-payment','Accept':'application/boli-paymentack','User-Agent':'Electrum'}
