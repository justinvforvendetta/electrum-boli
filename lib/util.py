...
def user_dir():
    if "HOME" in os.environ:
        return os.path.join(os.environ["HOME"], ".electrum-boli")
    elif "APPDATA" in os.environ:
        return os.path.join(os.environ["APPDATA"], "Electrum-BOLI")
    elif "LOCALAPPDATA" in os.environ:
        return os.path.join(os.environ["LOCALAPPDATA"], "Electrum-BOLI")
    elif 'ANDROID_DATA' in os.environ:
        return "/sdcard/electrum-BOLI/"
    else:
...
def create_URI(addr, amount, message):
    ...
    p = urlparse.ParseResult(scheme='boli', netloc='', path=addr, params='', query='&'.join(query), fragment='')
